...
// Example usage with an MP3 buffer
(async () => {
  try {
    const mp3Buffer = await fs.readFile("2.mp3"); // Replace with your MP3 file buffer
    const visemeData = await processAudioForVisemes(mp3Buffer);
